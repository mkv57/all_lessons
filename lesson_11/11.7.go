...
func main() {
	...
	for i := 0; i < len(a); i++ {
		...
		case 2:
			fmt.Println("a[", i, "] равно 2", " включение подачи инструмента без сож")
		case 3:
	...
	/* для работы станка с ЧПУ есть команды
	1) вкючение обработки материала (фанера) без "сож"(смазывающе-охлаждающая жидкость)
	 2) включение обработки материала (металл) с сож
	 3) вкючение просто насоса для подачи сож, охладить или промыть деталь
